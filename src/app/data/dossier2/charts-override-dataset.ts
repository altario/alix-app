/*
ChartsOverride name changed
FROM
chartsOverride
TO
dossier1ChartsOverride


data-comparison brought inside
name

FROM
dataComparison
TO
dossier1dataComparison



*/

export const dossier2dataComparison = {
  priceEvolutionBySc: {
...
export const dossier2ChartsOverride = {
  sqmDemandVsDays: [{
    color: '#FF0000',
    type: 'scatter',
    markArea: {
